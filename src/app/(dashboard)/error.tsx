...
export default function DashboardErrorPage({ error, reset }: ErrorProps) {
  return (
    <div className="ita-card login-mode" style={{height:"auto", minHeight:"220px", alignItems:"center", justifyContent:"center", gap:"12px", textAlign:"center"}}>
      ...
      <p style={{fontSize:"14px", fontWeight:600, color:"var(--text-primary)"}}>Erreur</p>
      <p style={{fontSize:"12px", color:"var(--text-muted)"}}>{error?.message || "Une erreur est survenue."}</p>
