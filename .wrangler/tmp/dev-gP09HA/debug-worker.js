...
// worker/debug-worker.ts
var debug_worker_default = {
  async fetch(request) {
    try {
      const result = {
        language: detectLanguage("test"),
        context: detectSkillContext("test"),
        prompt: buildSystemPrompt(
          { full_name: "Test", wilaya: "Alger", specializations: ["agriculture"], language_pref: "fr" },
          "general",
          "fr"
        )
      };
      return new Response(JSON.stringify({ ok: true, result: { language: result.language, context: result.context, promptLength: result.prompt.length } }), {
...
// .wrangler/tmp/bundle-0QFLSU/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = debug_worker_default;
...
// .wrangler/tmp/bundle-0QFLSU/middleware-loader.entry.ts
